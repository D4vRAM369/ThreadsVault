...
// ── Light Theme ──
val VaultBackgroundLight = Color(0xFFF6F8FC)
val VaultSurfaceLight = Color(0xFFFFFFFF)
val VaultSurfaceContainerLight = Color(0xFFF2F5FB)
val VaultSurfaceContainerHighLight = Color(0xFFEDF2FA)
val VaultSurfaceVariantLight = Color(0xFFE7EDF7)
